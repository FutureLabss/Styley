...
function getBotResponse(input) {
    ...
    if (input == "Alafin") { 
        return "<span style='font-size:smaller'>- Made by: Dilly Fashion Store -</span> <br /> Want to order this <strong>BLOUSE</strong>? <br /> <strong>Price:</strong> &#8358;9,000.0. <br /> Scroll to view all. &#8595; <br /> <br /> <strong>Front View</strong> <img data-toggle='modal' data-target='#exampleModalCenterAlafin' style='width:100%'  src='001.jpg' /> <br /> <br /> <strong>Side Views L-R</strong> <br /> <img data-toggle='modal' data-target='#exampleModalCenterAlafin' style='width:48%;'  src='001.jpg' /> <img data-toggle='modal' data-target='#exampleModalCenterAlafin' style='width:48%;' src='001.jpg' /> <br /> <br /> <strong>Back View</strong><img data-toggle='modal' data-target='#exampleModalCenterAlafin' style='width:100%'  src='001.jpg' /> <br /> <br /> Tab 'Alafin' to give your measurements & order this <strong>BLOUSE</strong> from its designer. <br /> <a href='https://forms.gle/Z9fiDRvAnYSUQ2qA6'> <button class='order-button' style='border-radius:11px; border: 3px solid; padding: 10px; margin-left: 5%;'>'Alafin'</button> <br /></a>";    
    // } else if (input == "Paga") {
